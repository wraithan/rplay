...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_profile', (
            ...
            ('default_match_share', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
            ('default_profile_share', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
        ))
    ...
    models = {
        ...
        'profiles.profile': {
            ...
            'default_profile_share': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
def parse_replay(match_id):
    ...
    try:
        ...
        match.save()
    except: # really? empty try/except block. you're an ass to yourself.
        pass # shutup, it's sunday evening and I do what I want.
        ### Day 1 on my journey to code schitzophrenia.

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Match', fields ['owner', 'matchhash']
        db.create_unique('sc2match_match', ['owner_id', 'matchhash'])

    def backwards(self, orm):
        # Removing unique constraint on 'Match', fields ['owner', 'matchhash']
        db.delete_unique('sc2match_match', ['owner_id', 'matchhash'])
